...
- `scout` for locating recently modified or adjacent code
- `sequential-thinking` or `problem-solving` when simplification candidates are ambiguous or risk behavior drift
