...
for (const skill of ["audit-context", "audit-plans", "generate-context", "generate-plan"]) {
...
for (const file of [
  ...
  ".claude/skills/generate-context/SKILL.md",
  ".claude/skills/generate-context/references/generate-context.md",
]) {
...
const staleWorkflowPatterns = [
  ...
  { pattern: "ck:plan", reason: "planning ownership was absorbed into generate-plan + plan-agent" },
  { pattern: "ck:research", reason: "research ownership was absorbed into research-agent" },
  { pattern: "ck:cook", reason: "execution ownership was absorbed into execute-agent" },
  { pattern: "ck:fix", reason: "bug-fix ownership was absorbed into debugger + execute-agent" },
  { pattern: "ck:code-review", reason: "review ownership was absorbed into code-reviewer" },
  { pattern: "/ck:journal", reason: "journal handoff is not part of the surviving default workflow surface" },
];
