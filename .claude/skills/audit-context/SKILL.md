...
7. Regenerate or check the machine-readable skill catalog:
   ```bash
   node .claude/skills/audit-context/scripts/generate-skills-catalog.mjs --write
...
- Treat `.claude/skills/audit-context/references/skill-routing-policy.json` as the explicit allowlist for intentionally non-routed shared skills.
