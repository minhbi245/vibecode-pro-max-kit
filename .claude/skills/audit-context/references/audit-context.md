...
- Context validator scripts under `.claude/skills/audit-context/scripts/`
...
2. Confirm `audit-context` exists at both:
   - `.claude/skills/audit-context/SKILL.md`
   - `.agents/skills/audit-context/SKILL.md`
...
node .claude/skills/audit-context/scripts/validate-skill-routing.mjs
node .claude/skills/audit-context/scripts/validate-skill-cross-refs.mjs
node .claude/skills/audit-context/scripts/validate-skill-dependencies.mjs
node .claude/skills/audit-context/scripts/validate-confusable-skills.mjs
node .claude/skills/audit-context/scripts/generate-skills-catalog.mjs --check
```
...
node .claude/skills/audit-vc/scripts/validate-guide-sync.mjs
node .claude/skills/audit-vc/scripts/validate-protocol-wiring.mjs
```
